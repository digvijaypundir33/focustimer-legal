...
**Crash Reports** — If you have shared diagnostics with Apple (in iOS/macOS settings), Apple may forward crash data to us in anonymised form.

## Data We Do NOT Collect

- We do not collect your name, email address, or any contact information.
- We do not track your location.
- We do not use advertising SDKs or analytics SDKs that phone home.
- We do not have accounts or a backend server that stores your data.
...
All purchases are processed by Apple via the App Store. We receive only a confirmation of your subscription status — no payment details or billing information.
...
We may update this Privacy Policy periodically. Changes will be reflected in the "Last updated" date above. Continued use of the app after changes constitutes acceptance of the updated policy.

## Contact

Questions about this Privacy Policy? Email us at: digvijay.pundir33@gmail.com
